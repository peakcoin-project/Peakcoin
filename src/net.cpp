...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Peakcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"peakcointools.com", "peakcointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"peakcointools.com", "testnet-seed.peakcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Peakcoin is probably already running."), addrBind.ToString().c_str());
        else
